        ...
        with requests.Session() as session:
            ...
            if 'type="submit"' in str(self.base64_string):
                ...
                if len(self.find_form_follower) >= 2:
                    self.form_followerlink, self.followerlink = self.find_form_video[1][0], self.find_form_follower[1][1]
                ...
                data = MultipartEncoder(
                    {
                        ...
                        self.form_followerlink: (None, self.followerlink)
                    }, boundary=boundary
                )
    ...
    def __init__(self) -> None:
        try:
            ...
            if 'tiktok.com' in str(follower_url) or '/follower/' in str(follower_url):
                ...
                printf(Panel(f"[bold red]Please fill in the TikTok video link correctly, make sure you take the follower link in the browser!", width=56, style="bold bright_white", title="[bold bright_white][ Link Salah ]"))
                sys.exit()
